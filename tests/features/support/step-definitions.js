...
defineStep('I find/identify/see/spot (a/an/the)( ){target}', (qa) =>
  i.seeATarget(qa));
defineStep('I find/identify/see/spot (a/an/the)( ){target} in/on the {target}', (qa, parentQa) =>
...
defineStep('I activate/click (on )(the/a/an)( ){target} in/on the {target}', (qa, parentQa) =>
