export default {
  ...
  "debias": {
    "background": {
      ...
      "text": "Tieto informácie vytvoril {link} (2023/2024) s cieľom pomôcť uviesť do kontextu zastarané a škodlivé pojmy v popisoch zbierok."
    },
    "headings": {
      "alternatives": "Navrhované alternatívy",
      "recommendations": "Odporúčania na použitie",
      "source": "Zdroj"
    },
    "termNotFound": "Táto stránka je dostupná iba v jazyku zaujatého termínu.",
    "tooltip": {
      "linkToPage": "Prečítajte si celé vysvetlenie, ktoré poskytol {projectName}"
    }
  },
  "debug": {
    "apiRequests": {
      "form": {
        "apiKey": {
          "descriptionLine1": "Zadajte svoj kľúč Europeana API a použije sa v odkazoch na požiadavky API.",
          "descriptionLine2": "Potrebujete API kľúč? Zaregistrujte sa a získajte ho {link}.",
          "here": "tu",
          "label": "Kľúč API",
          "usePersonal": {
  ...
  "ds4ch": {
    "broughtBy": "Prináša vám",
    "footer": {
      "disclaimerLine1": "Spoločný európsky dátový priestor pre kultúrne dedičstvo je iniciatívou Európskej únie financovanou z programu Európskej únie Digitálna Európa. Služby dátového priestoru vrátane tejto webovej stránky prevádzkuje konzorcium vedené nadáciou Europeana na základe zmluvy o poskytovaní služieb s Európskou komisiou."
    },
    "header": {
      "navigation": {
        "about": "O dátovom priestore",
        "explore": "Preskúmajte údaje",
        "partners": "Partneri"
      }
    },
    "homeLinkAlt": "Domovská stránka spoločného európskeho dátového priestoru pre kultúrne dedičstvo"
  },
  ...
  "footer": {
    ...
    "disclaimerLine1": "Spoločný európsky dátový priestor pre kultúrne dedičstvo je iniciatívou Európskej únie financovanou z programu Európskej únie Digitálna Európa. Služby dátového priestoru vrátane tejto webovej stránky prevádzkuje konzorcium vedené nadáciou Europeana na základe zmluvy o poskytovaní služieb s Európskou komisiou, číslo zmluvy LC-01901432.",
  ...
  "landing": {
    "apis": {
      "footer": {
        "name": "Zdroje",
        "navigation": {
          "apiDocumentation": "Dokumentácia API",
          "contactUs": "Kontaktujte nás",
          "requestApiKey": "Požiadať o API kľúč"
        }
      },
      "header": {
        ...
        "navigation": {
          ...
          "faq": "FAQ",
          "findInspiration": "Nájdite inšpiráciu"
        }
      }
    },
    "counts": {
      "apiRequests": "Priemerný počet mesačných API požiadaviek",
