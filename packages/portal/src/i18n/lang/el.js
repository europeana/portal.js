export default {
  ...
  "ds4ch": {
    ...
    "footer": {
      "disclaimerLine1": "Ο κοινός ευρωπαϊκός χώρος δεδομένων για την πολιτιστική κληρονομιά είναι μια πρωτοβουλία της Ευρωπαϊκής Ένωσης, η οποία χρηματοδοτείται από το πρόγραμμα «Ψηφιακή Ευρώπη» της Ευρωπαϊκής Ένωσης. Οι υπηρεσίες του χώρου δεδομένων, συμπεριλαμβανομένου αυτού του ιστότοπου, λειτουργούν από μια κοινοπραξία με επικεφαλής το Ίδρυμα Europeana, βάσει σύμβασης παροχής υπηρεσιών με την Ευρωπαϊκή Επιτροπή."
    },
    "header": {
      "navigation": {
