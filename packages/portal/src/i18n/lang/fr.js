export default {
  ...
  "embedNotification": {
    "ifNotAll": "Si vous ne voulez pas charger tous les médias intégrés, vous pouvez {0}.",
    "loadAllEmbeddedContent": "Charger tout le contenu intégré",
    "loadOnlyThis": "charger les médias de ce fournisseur uniquement",
    "message": "Veuillez noter que cette page contient du contenu médiatique intégré à partir de {provider}. La consultation de ces médias est soumise aux conditions d'utilisation et aux déclarations de confidentialité de ces sites. Veuillez consulter leurs déclarations de confidentialité pour plus d'informations sur l'utilisation de vos données.",
    "messageUnkownService": "Malheureusement, ce contenu ne peut pas être affiché.",
    "ofThirdPartyServices": "{0} des services de contenu de tiers.",
    "viewFullList": "Voir la liste complète",
    "viewThisExternalLink": "Voir ce contenu via un lien externe"
  },
  "entity": {
    "actions": {
      "cancel": "Annuler",
  ...
  "facets": {
    ...
    "collection": {
      ...
      "options": {
        ...
        "art": "Art",
        "audiovisual": "Patrimoine audiovisuel",
        "fashion": "Mode",
    ...
    "COLOURPALETTE": {
      ...
      "options": {
        ...
        "#8B4513": "Foncé moyen orange",
        "#8FBC8F": "Vert mer foncé",
        "#90EE90": "Vert clair",
        "#9370DB": "Violet moyen",
        "#9400D3": "Violet foncé",
        "#98FB98": "Vert pâle",
        "#9932CC": "Rouge orchidée foncé",
        ...
        "#B0E0E6": "Poudre bleue",
        "#B22222": "Brique réfractaire",
        "#B8860B": "Foncé moyen jaune",
        "#BA55D3": "Rouge orchidée moyen",
        "#BC8F8F": "Rosy Brown",
        "#BDB76B": "Kaki foncé",
        "#BEBEBE": "Gris",
        "#C0C0C0": "argent",
        ...
        "#F5FFFA": "Crème de menthe",
        "#F8F8FF": "Blanc fantôme",
        "#FA8072": "Saumon",
        "#FAEBD7": "Blanc antique",
        "#FAF0E6": "Lin",
        "#FAFAD2": "Verge d'or clair",
        "#FDF5E6": "Blanc vieille dentelle",
        "#FF0000": "rouge",
        "#FF00FF": "Fuchsia",
        "#FF1493": "Rose foncé",
        "#FF4500": "Rouge-orange",
  ...
  "fieldLabels": {
    "default": {
      ...
      "dctermsHasVersion": "A une version",
      "dctermsIsFormatOf": "Est un format de",
      "dctermsIsPartOf": "Fait partie de",
      "dctermsIsReferencedBy": "Est référencé par",
      "dctermsIsReplacedBy": "Est remplacé par",
      "dctermsIsRequiredBy": "Est requis par",
  ...
  "galleries": {
    ...
    "seeAllPublished": "Voir toutes les galeries publiées"
  },
  "header": {
    "clearQuery": "Effacer la requête de recherche",
    "closeSidebar": "Fermer le menu",
    "collapseSearchBar": "Réduire la barre de recherche",
  ...
  "klaro": {
    "main": {
      ...
      "consentNotice": {
        "description": "Pourrions-nous activer les services de sécurité, d'analyse et de contenu tiers ?",
        "learnMore": "Gérer les paramètres des cookies"
      },
      "decline": "Refuser",
      "purposes": {
        "2D": {
        ...
        "mediaViewing": {
          "description": "Ces services chargent des éléments d'image (2D), 3D, audio et vidéo en vue de leur visualisation.",
          "title": "Services de visionnage de médias"
        },
        "multimedia": {
          "title": "Multimédia"
        },
        "other": {
          "description": "Ces services chargent du contenu tel que du code, des jeux, des cartes et des widgets de narration.",
          "title": "Autres services d'intégration"
        },
        "socialMedia": {
          "description": "Ces services chargent le contenu des plateformes de médias sociaux.",
          "title": "Services d'intégration des médias sociaux"
        },
        "thirdPartyContent": {
          "description": "Ces services chargent du contenu hébergé par des tiers. Son utilisation est soumise aux conditions générales et à la déclaration de confidentialité de ces tiers.",
    ...
    "services": {
      ...
      "cloudflare": {
        "description": "Se souvient que le défi de sécurité a été réussi avec succès.",
        "title": "Cloudflare"
      },
      "debugSettings": {
  ...
  "map": {
    "keyboardNavigatePins": "Utilisez les touches fléchées pour parcourir les épingles",
    "keyboardPanAndZoom": "Utilisez les touches +, - et les flèches pour zoomer et vous déplacer sur la carte",
    "togglePin": "Basculer l’épingle",
    "zoomInCluster": "Zoom sur le cluster"
  },
  "media": {
    "controls": {
  ...
  "organisation": {
    ...
    "geographicScope": "Champ d'application géographique",
    "heritageDomain": "Types de patrimoine",
    "nameAcronym": "Acronyme du nom",
    "providesAudienceEngagementActivity": "Activités d’engagement du public",
    "providesCapacityBuildingActivity": "Renforcement des capacités",
    "providesSupportForDataActivity": "Activités liées aux données",
    "providesSupportForMediaType": "Type de média",
    "providingInstitutionsCount": "Nombre d'institutions prestataires",
    "recordCount": "Nombre d'items"
  },
  "organisations": {
    "aggregators": {
      "description": "Les agrégateurs travaillent avec les institutions fournisseuses pour collecter et publier leurs items du patrimoine culturel numérique sur Europeana.eu.",
      "title": "Agrégateurs"
    },
    "internationalAggregators": {
      "description": "Les agrégateurs de domaines et de thèmes définissent leur champ d'action par secteur culturel (comme les musées, les archives ou les bibliothèques) ou par sujet et thème (comme la mode). Ils travaillent avec des contributeurs basés dans différents pays européens.",
      "title": "Agrégateurs de domaines et de thèmes"
    },
    "providingInstitutions": {
      "description": "Une liste de musées, bibliothèques, archives et galeries qui partagent leurs items du patrimoine culturel numérique sur Europeana.eu.",
      "title": "Institutions prestataires"
    },
    "regionalAggregators": {
      "description": "Les agrégateurs nationaux et régionaux définissent leur champ d'action par pays ou région. Ils collaborent avec des contributeurs situés dans ce pays ou cette région.",
      "title": "Agrégateurs nationaux et régionaux"
    }
  },
  ...
  "record": {
    ...
    "allMetaDataInfo": "Informations sur cet item en entier.",
  ...
  "related": {
    ...
    "collection": {
      "preview": "Aperçu de la collection"
    },
    "collections": {
  ...
  "search": {
    "advanced": {
      ...
      "newRule": "nouvelle règle de recherche avancée",
      "placeholder": {
