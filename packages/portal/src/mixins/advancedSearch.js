...
const advancedSearchFields = [
  ...
  { name: 'proxy_dc_contributor', type: FIELD_TYPE_TEXT, suggestEntityTypes: [FIELD_SUGGEST_AGENT] },
  { name: 'proxy_dc_coverage', type: FIELD_TYPE_STRING, suggestEntityTypes: [FIELD_SUGGEST_PLACE] },
  { name: 'proxy_dc_creator', type: FIELD_TYPE_TEXT, suggestEntityTypes: [FIELD_SUGGEST_AGENT] },
  { name: 'proxy_dc_date', type: FIELD_TYPE_STRING, suggestEntityTypes: [FIELD_SUGGEST_TIMESPAN] },
  { name: 'proxy_dc_description', type: FIELD_TYPE_TEXT },
  { name: 'proxy_dc_format', type: FIELD_TYPE_TEXT, suggestEntityTypes: [FIELD_SUGGEST_CONCEPT] },
  ...
  { name: 'proxy_dc_subject', type: FIELD_TYPE_TEXT, suggestEntityTypes: [FIELD_SUGGEST_CONCEPT, FIELD_SUGGEST_PLACE, FIELD_SUGGEST_TIMESPAN, FIELD_SUGGEST_AGENT] },
  { name: 'proxy_dc_title', type: FIELD_TYPE_TEXT },
  { name: 'proxy_dc_type', type: FIELD_TYPE_STRING, suggestEntityTypes: [FIELD_SUGGEST_CONCEPT] },
  { name: 'proxy_dcterms_alternative', type: FIELD_TYPE_STRING },
  { name: 'proxy_dcterms_created', type: FIELD_TYPE_STRING, suggestEntityTypes: [FIELD_SUGGEST_TIMESPAN] },
  ...
  { name: 'proxy_dcterms_medium', type: FIELD_TYPE_TEXT, suggestEntityTypes: [FIELD_SUGGEST_CONCEPT] },
  { name: 'proxy_dcterms_provenance', type: FIELD_TYPE_STRING },
  { name: 'proxy_dcterms_spatial', type: FIELD_TYPE_STRING, suggestEntityTypes: [FIELD_SUGGEST_PLACE] },
  { name: 'proxy_dcterms_temporal', type: FIELD_TYPE_STRING, suggestEntityTypes: [FIELD_SUGGEST_TIMESPAN] },
  ...
  { name: 'what', type: FIELD_TYPE_TEXT, suggestEntityTypes: [FIELD_SUGGEST_CONCEPT, FIELD_SUGGEST_PLACE, FIELD_SUGGEST_TIMESPAN, FIELD_SUGGEST_AGENT], aggregated: true },
  { name: 'when', type: FIELD_TYPE_TEXT, suggestEntityTypes: [FIELD_SUGGEST_TIMESPAN], aggregated: true },
  { name: 'where', type: FIELD_TYPE_TEXT, suggestEntityTypes: [FIELD_SUGGEST_PLACE], aggregated: true },
  { name: 'who', type: FIELD_TYPE_TEXT, suggestEntityTypes: [FIELD_SUGGEST_AGENT], aggregated: true },
  { name: 'YEAR', type: FIELD_TYPE_STRING }
];

const advancedSearchFieldsForEntityLookUp = advancedSearchFields.filter(field => field.suggestEntityTypes && !field.aggregated);
          ...
          for (const fieldType in modifier.patterns) {
            ...
            if (match?.groups && field) {
              return {
                ...
                ...(field.suggestEntityTypes && { suggestEntityTypes: field.suggestEntityTypes }),
