...
const advancedSearchFields = [
  ...
  { name: 'what', type: FIELD_TYPE_TEXT, suggestEntityType: FIELD_SUGGEST_CONCEPT },
  { name: 'when', type: FIELD_TYPE_TEXT, suggestEntityType: FIELD_SUGGEST_TIMESPAN },
  { name: 'where', type: FIELD_TYPE_TEXT, suggestEntityType: FIELD_SUGGEST_PLACE },
  { name: 'who', type: FIELD_TYPE_TEXT, suggestEntityType: FIELD_SUGGEST_AGENT },
