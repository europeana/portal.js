  ...
  >
    ...
    >
                  ...
                  <div class="ml-lg-auto d-flex justify-content-center flex-wrap flex-md-nowrap">
                    ...
                    <client-only>
                      <UserButtons
                        ...
                        :show-pins="userIsEntitiesEditor && userIsSetsEditor && (europeanaEntities.length > 0)"
      ...
      >
        ...
        <!-- TODO: mv into ShareWidget w/ ShareButton -->
        <ShareSocialModal
...
<script>
  ...
  import DownloadWidget from '@/components/download/DownloadWidget';
  import RightsStatementButton from '@/components/generic/RightsStatementButton';
  ...
  export default {
    ...
    components: {
      ...
      ItemMediaPresentation: () => import('@/components/item/ItemMediaPresentation'),
      ItemRecommendations,
      ItemSummaryInfo: () => import('@/components/item/ItemSummaryInfo'),
      ItemTranscribeButton: () => import('@/components/item/ItemTranscribeButton'),
      LoadingSpinner,
      MetadataBox,
      ...
      ShareSnippet,
      ShareSocialModal,
      UserButtons: () => import('@/components/user/UserButtons')
    },
