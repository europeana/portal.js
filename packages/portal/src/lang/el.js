export default {
  ...
  "facets": {
    "api": {
      "name": "Αναζήτηση εντός εγγράφων",
      "options": {
        "fulltext": "Τεκμήριο με πλήρες κείμενο",
        "metadata": "Τεκμήρια μόνο με μεταδεδομένα"
      },
      "switch": "Αναζήτηση μόνο στο περιεχόμενο των στοιχείων με πλήρες κείμενο",
      "switchMoreInfo": "Σε αυτή τη συλλογή, μπορείτε να επιλέξετε το τι θέλετε να αναζητήσετε: εάν αυτή η επιλογή είναι ενεργοποιημένη, τότε θα αναζητήσετε σε κείμενα εφημερίδων και εγγράφων, εάν είναι απενεργοποιημένη, τότε θα αναζητήσετε σε περιγραφές των τεκμήρια, όπως συμβαίνει πάντα στις περισσότερες συλλογές."
    },
    "button": {
  ...
  "record": {
    ...
    "transcriptionDisclaimer": "Το περιεχόμενο προέρχεται από την κοινότητα και όχι από το ίδρυμα που παρείχε το τεκμήριο."
  },
  "related": {
    "categoryTags": {
  ...
  "search": {
    "advanced": {
      ...
      "tooltip": {
        ...
        "term": "Εισαγάγετε τους όρους που θέλετε να αναζητήσετε ή να εξαιρέσετε."
      }
    },
    "boost": {
  ...
  "set": {
    ...
    "publication": {
      "criteria": {
        "description": "Για να ληφθεί υπόψη για δημοσίευση, μια γκαλερί πρέπει να περιλαμβάνει τίτλο και περιγραφή και να περιέχει τουλάχιστον 20 τεκμήρια.",
