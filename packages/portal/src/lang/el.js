export default {
  ...
  "entity": {
    "actions": {
      "cancel": "Ακύρωση",
      "pin": "Καρφιτσώστε το αντικείμενο",
      "unpin": "ξεκαρφώστε το αντικείμενο",
    ...
    "notifications": {
      ...
      "pinned": "Το στοιχείο έχει καρφιτσωθεί. Θα εμφανιστεί ως το πρώτο στοιχείο στη συλλογή \" {entity} \". Θα σας ειδοποιήσουμε όταν αυτή η αλλαγή θα είναι ορατή στη σελίδα συλλογής.",
      ...
      "unpinned": "Το στοιχείο καρφιτσώθηκε. Θα σας ειδοποιήσουμε όταν αυτή η αλλαγή θα είναι ορατή στη σελίδα συλλογής."
    }
  },
  "error": "Σφάλμα",
  "errorMessage": {
    ...
    "pinningNotFound": {
      "description": "Παρουσιάστηκε σφάλμα κατά την καρφίτσωση/αποκαρφίτσωση του αντικειμένου. Παρακαλώ δοκιμάστε ξανά ή αναφέρετε το πρόβλημα.",
  ...
  "fieldLabels": {
    "default": {
      ...
      "edmRights": "Δήλωση δικαιωμάτων για τα μέσα σε αυτό το αντικείμενο (εκτός αν ορίζεται διαφορετικά)",
  ...
  "homePage": {
    ...
    "themesTitle": "Εξερεύνηση ανά θέμα",
  ...
  "modal": {
    ...
    "transcribe": {
      ...
      "title": "Μεταγραφή αυτού του στοιχείου"
    }
  },
  "multilingual": {
    ...
    "translateMetadata": "Μεταφράστε τα μεταδεδομένα αυτού του αντικειμένου.",
    "translateQuotaError": "Η υπηρεσία μετάφρασης δεν είναι προσωρινά διαθέσιμη. Παρακαλώ προσπαθήστε ξανά αργότερα."
  },
  "newFeatureNotification": {
    "dismiss": "Κλείσιμο",
    "readMore": "Μεταβείτε στη σελίδα αναζήτησης",
    "text": {
      "advancedSearch": "Η σύνθετη αναζήτηση έφτασε: αποχαιρετήστε τα ευρεία αποτελέσματα και γεια στην ακρίβεια καθώς αποκαλύπτετε ακριβώς αυτό που ψάχνετε. Ξεκινήστε την εξερεύνηση τώρα!"
    }
  },
  ...
  "rights": {
    "tooltip": {
      "open": "{rightsStatementName} σημαίνει ότι μπορείτε να χρησιμοποιήσετε αυτό το στοιχείο ελεύθερα. {readMoreLink}",
      "permission": "{rightsStatementName} σημαίνει ότι ενδέχεται να μπορείτε να χρησιμοποιήσετε αυτό το στοιχείο εάν ζητήσετε άδεια. {readMoreLink}",
      "readMore": "Διαβάστε περισσότερα στο {link}",
      "restricted": "{rightsStatementName} σημαίνει ότι μπορείτε να χρησιμοποιήσετε αυτό το στοιχείο με προϋποθέσεις. {readMoreLink}"
    }
  },
  "search": {
    "advanced": {
      "input": {
        ...
        "searchTerm": "Εισαγάγετε όρους αναζήτησης"
      },
      "modifiers": {
        "contains": "περιέχει",
      ...
      "tooltip": {
        "field": "Επιλέξτε ένα πεδίο για αναζήτηση.",
  ...
  "searchPlaceholder": "Κάντε αναζήτηση ανάμεσα σε 50+ εκατομμύρια αντικειμένων",
  "searchResults": "Αναζήτηση",
  "searchResultsFor": "{0} - Αναζήτηση",
  "searchSuggestions": "Αναζήτηση προτάσεων",
  "searchTier": {
    "button": {
      "hide": "Απόκρυψη αυτών των αντικειμένων",
      "show": "Εμφάνιση αυτών των αντικειμένων"
    },
    "text": {
      "hide": "Εμφανίζονται στοιχεία που δεν πληρούν τα κριτήρια δημοσίευσης μας.",
      "show": "Περισσότερα στοιχεία αντιστοιχούν στην αναζήτησή σας, αλλά δεν πληρούν τα κριτήρια δημοσίευσης μας."
    }
  },
  "searchViews": {
  ...
  "set": {
    "actions": {
      ...
      "addToGallery": "Προσθέστε αυτό το αντικείμενο σε μια γκαλερί.",
      "create": "Δημιουργία συλλογής",
      "createNew": "Δημιουργία νέας συλλογής",
      "delete": "Διαγραφή συλλογής",
      "edit": "Επεξεργασία συλλογής",
      "saveItemToLikes": "Αποθήκευση αυτού του αντικειμένου στα Αρέσει σας.",
      "update": "Ενημέρωση συλλογής"
    },
    "entityBestBets": {
      "title": "{entity} Σελίδα"
