export default {
  ...
  "set": {
    ...
    "shareTo": {
      "weavex": {
        "tooltip": "Το WEAVExperience (WEAVEx) είναι ένα διαδικτυακό εργαλείο για τη διαχείριση περιεχομένου διαφορετικών τύπων (συμπεριλαμβανομένου του 3D), την τεκμηρίωση της πολιτιστικής κληρονομιάς μέσω χώρων ψηφιακής κοινότητας και την επιμέλεια ψηφιακών ιστοριών και εμπειριών."
      }
    }
  },
