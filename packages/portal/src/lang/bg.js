export default {
  ...
  "entity": {
    ...
    "notifications": {
      ...
      "error": {
        "unpin": "Възникна грешка при откачането на елемента. Моля, опитайте отново или докладвайте за проблема."
      },
  ...
  "notificationBanner": {
    "text": {
      "setsKeycloakMaintenance": "Поради планирана поддръжка, функциите за акаунт, влизане, харесвания и галерии няма да бъдат достъпни или ограничени в четвъртък, 23 февруари, от 7:00 до 9:00 сутринта централноевропейско време."
    }
  },
  "of": "На",
  "organisation": {
