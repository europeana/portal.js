export default {
  ...
  "facets": {
    "api": {
      "name": "Търсене в документи",
      "options": {
        "fulltext": "Oбекта с пълен текст",
        "metadata": "Oбекта само с метаданни"
      },
      "switch": "Търсете само в съдържанието на обекта с пълен текст",
      "switchMoreInfo": "В тази колекция можете да изберете какво искате да търсите: ако този превключвател е включен, тогава ще търсите в текста на вестника и документа; ако е изключен, тогава вместо това ще търсите в информацията, описваща обект, точно както винаги правите в повечето други колекции."
    },
    "button": {
  ...
  "newFeatureNotification": {
    "dismiss": "Отхвърляне",
    "readMore": "Отидете на страницата за търсене",
    "text": {
      "advancedSearch": "Разширеното търсене пристигна: кажете сбогом на широките резултати и здравейте на прецизността, докато откривате точно това, което търсите. Започнете да изследвате сега!"
    }
  },
  ...
  "search": {
    "advanced": {
      "input": {
        ...
        "searchTerm": "Въведете дума(и) за търсене"
      },
      "modifiers": {
        "contains": "съдържа",
      ...
      "tooltip": {
        ...
        "field": "Изберете поле за търсене.",
        "modifier": "Изберете модификатор, който да приложите към полето.",
        "term": "Въведете термина(ите) за търсене или за изключване."
      }
    },
    "boost": {
  ...
  "set": {
    ...
    "publication": {
      "criteria": {
        "description": "За да бъде разгледана за публикуване, една галерия трябва да включва заглавие и описание и трябва да съдържа минимум 20 обекта.",
        "title": "Критерии за публикуване"
      },
      "description": "Публикуването на галерия ще я покаже на Europeana.eu/galleries.",
      "failedSubmission": "Заявката е неуспешна. Моля, опитайте отново.",
      "process": {
        "description": "Когато изпратите галерия за публикуване, ще бъде уведомен екип от издатели в Europeana. Те първо ще го прегледат и могат да направят промени, преди да бъде публикуван. Ще получавате известия по имейл, докато галерията се преглежда. Ако не бъде публикувана, може да се окаже, че не отговаря на нашите редакционни насоки.",
