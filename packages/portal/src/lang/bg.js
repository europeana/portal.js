export default {
  ...
  "entity": {
    ...
    "notifications": {
      ...
      "pin": "Този елемент ще се показва в горната част на колекцията „ {entity} “. Ще ви уведомим, когато тази промяна ще бъде видима на страницата за събиране.",
      "pinLimit": {
      ...
      "select": "Изберете свързан обект, за да фиксирате/откачите елемента към/от него.",
      "unpin": "Този елемент ще спре да се показва в горната част на колекцията „ {entity} “. Ще ви уведомим, когато тази промяна ще бъде видима на страницата за събиране.",
  ...
  "errorMessage": {
    ...
    "itemNotFound": {
      "description": "Това може да се дължи на следните причини: този елемент не съществува или; беше отменено публикуването му, защото не отговаряше на нашите критерии за качество, или; той беше актуализиран и публикуван отново с нов уникален идентификатор, в който случай опитайте да намерите елемента отново.",
      "metaTitle": "Артикулът не е намерен",
      "title": "О, не! {newline} Не успяхме да намерим този артикул."
    },
    "pageNotFound": {
    ...
    "pinningNotFound": {
      "description": "Възникна грешка при фиксирането/откачването на елемента. Моля, опитайте отново или докладвайте за проблема.",
  ...
  "modal": {
    ...
    "downloadFailed": {
      "linkPrompt": "Съветваме ви да кликнете върху бутона „Предоставяне на институция“ по-долу, за да проверите дали артикулът може да бъде изтеглен от уебсайта на предоставящата институция.",
      "message": "Ако изтеглянето не работи, това може да е, защото е било премахнато от предоставящата институция или може да има технически проблем с тяхната услуга.",
    ...
    "transcribe": {
      ...
      "title": "Транскрибирайте този елемент"
    }
  },
  "multilingual": {
  ...
  "newFeatureNotification": {
    ...
    "text": {
      "themes": "Изследвайте европейското културно наследство чрез теми, от археология до Първата световна война. Нашите нови тематични страници предлагат многоизмерен изглед на всяка тема чрез свързани теми, хора, истории и предмети."
    }
  },
  ...
  "record": {
    "actions": {
      "pin": "Закачване на елемент към налични обекти"
    },
    ...
    "status": {
      "unpublished": "[Непубликувани елемент]"
    },
