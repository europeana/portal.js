export default {
  ...
  "entity": {
    ...
    "notifications": {
      ...
      "unpinned": "Oбект е премахнат. Той вече не се намира в горната част на първата страница на тази колекция. Може да отнеме до 24 часа да изчезне за всички."
    }
  },
  "error": "Грешка",
  "errorMessage": {
