  ...
  describe('when enabled', () => {
    ...
    describe('when header value configured', () => {
      ...
      describe('when not logged-in', () => {
        describe('when route has specific config', () => {
          it('sets cache-control from app config, route-specific scope', () => {
            const ctx = {
              $config: { app: { cacheControl: { enabled: true, default: 'no-cache', route: { itemAll: 'public' } } } },
              res: { removeHeader: sinon.spy(), setHeader: sinon.spy() },
        ...
        describe('when route has no specific config', () => {
