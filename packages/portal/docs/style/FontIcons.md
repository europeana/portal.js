Apply the icon's class to an element to have it prefixed with the icon.
  ...
  <b-container>
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>Info outline</td>
          <td><code>icon-info-outline</code></td>
          <td><span class="icon icon-info-outline" /></td>
        </tr>
        <tr>
          <td>Instagram</td>
