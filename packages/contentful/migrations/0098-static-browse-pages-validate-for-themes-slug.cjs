  ...
  [browsePage, staticPage].forEach(page =>
    page
      ...
      .validations([
        ...
        {
          prohibitRegexp: {
            pattern: '^(account$|account/|api$|api/|blog$|blog/|collections/|contentful/|debug$|debug/|exhibitions$|exhibitions/|galleries$|galleries/|iiif$|item/|media$|record/|schemas$|schemas/|search$|themes$|themes/)',
            flags: null
          },
