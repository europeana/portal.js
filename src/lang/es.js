export default {
  ...
  "fieldLabels": {
    "default": {
      ...
      "edmRights": "Licencia de los medios en este registro (a menos que se especifique lo contrario)",
    ...
    "webResource": {
      ...
      "edmRights": "Licencia para este recurso multimedia",
      "rdfAbout": "RDF About"
    }
  },
  "filter": "Filtrar",
  ...
  "newFeatureNotification": {
    ...
    "readMore": "Leer más",
    "text": {
      "searchFilters": "Nuestros filtros de búsqueda ahora admiten la búsqueda; ¡Echale un vistazo! También rediseñamos nuestras páginas de resultados y colecciones."
    }
  },
  ...
  "sideFilters": {
    ...
    "search": "Buscar",
    "select": "Seleccione un | {filter} Seleccione {filtro}"
  },
  "statuses": {
    "liked": "Gustó",
    "pinned": "Fijado"
