export default {
  "account": {
    ...
    "curatedCollectionsInfo": "Sib hawn taħt il-kollezzjonijiet kollha li kkurajt",
  ...
  "collections": {
    "actions": {
      "edit": "Editja Kollezzjoni",
      "update": "Aġġorna Kollezzjoni"
    },
    "fashion": {
      "facets": {
        "CREATOR": {
  ...
  "entity": {
    "actions": {
      "cancel": "Ikkanċella",
      "pin": "Oġġett tal-pin",
      "unpin": "Neħħi l-oġġett",
      "viewPinned": "Ara l-oġġetti mwaħħlin"
    },
    "labels": {
      "entity": "Entità"
    },
  ...
  "items": {
    ...
    "recommendationsDisclaimer": "Thumb up biex iżżid mal-gallerija - Thumb down jekk ma tħobbx",
  ...
  "klaro": {
    "main": {
      ...
      "service": {
        "disableAll": {
          "description": "Uża dan is-swiċċ biex tippermetti jew tiddiżattiva s-servizzi fakultattivi kollha.",
          "title": "Jippermetti jew itfi s-servizzi kollha"
        }
      }
    },
    "services": {
  ...
  "searchTier": {
    "button": {
      "hide": "Aħbi dawn l-oġġetti",
      "show": "Uri dawn l-oġġetti"
    },
    "text": {
      "hide": "Qed jintwerew oġġetti li ma jissodisfawx il-kriterji tal-pubblikazzjoni tagħna.",
      "show": "Hemm aktar oġġetti li jaqblu mat-tfittxija tiegħek iżda ma jissodisfawx il-kriterji tal-pubblikazzjoni tagħna."
    }
  },
  "searchViews": {
    "grid": "Dehra tal-grilja",
    "list": "Dehra tal-lista"
  },
  "set": {
    "actions": {
