export default {
  ...
  "facets": {
    ...
    "RIGHTS": {
      ...
      "options": {
        "*\/CNE\/*": "Autorsko pravo nije procijenjeno",
        "*\/InC-EDU\/*": "U autorskim pravima - dopuštena je obrazovna upotreba",
        "*\/InC-OW-EU\/*": "U autorskom pravu - OW-EU",
        "*\/InC\/*": "U autorskom pravu",
        "*\/NoC-NC\/*": "Bez autorskih prava - samo za nekomercijalnu upotrebu",
        "*\/NoC-OKLR\/*": "Bez autorskih prava - druga poznata zakonska ograničenja",
        ...
        "*\/rights\/out-of-copyright-non-commercial\/*": "Izvan autorskih prava - nekomercijalna ponovna upotreba",
        "*\/rights\/rr-f\/*": "Prava pridržana - slobodan pristup",
        "*\/rights\/unknown\/*": "Nepoznat status autorskih prava"
      }
    },
    "TYPE": {
      "name": "Vrsta medija",
  ...
  "sideFilters": {
    ...
    "search": "traži",
    "select": "Odaberite {filter} | Odaberite {filter}"
  },
  "statuses": {
    "liked": "Volio",
    "pinned": "Prikvačeno"
