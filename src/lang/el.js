export default {
  ...
  "items": {
    ...
    "recommendationsDisclaimer": "Με τον αντίχειρα προς τα πάνω για να το προσθέσετε στη γκαλερί - Με τον αντίχειρα προς τα κάτω αν δεν σας αρέσει",
  ...
  "linksToClassic": {
    "home": {
      "linkText": "Δείτε αυτήν τη σελίδα στον αρχικό ιστότοπο Europeana έως τις 20 Δεκεμβρίου 2021.",
      "text": "Βλέπετε τη νέα εμπειρία της Europeana."
    },
    "record": {
      "linkText": "Δείτε αυτό το στοιχείο στον αρχικό ισότοπο Europeana έως τις 20 Δεκεμβρίου 2021.",
      "text": "Βλέπετε αυτό το αντικείμενο στο νέο ιστότοπο της Europeana."
    },
    "search": {
      "linkText": "Αναζητήστε στον αρχικό ισότοπο Europeana έως τις 20 Δεκεμβρίου 2021.",
