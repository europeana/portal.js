export default {
  ...
  "homePage": {
    "discoverEditorial": "Ανακαλύψτε τις ιστορίες μας",
    "download": "Kατεβάστε",
    "free": "Δωρεάν",
    "storiesCTA": "Δείτε όλες τις ιστορίες μας",
    "subHeadline": "Βρείτε και {κατεβάστε} έργα τέχνης, φωτογραφίες, βιβλία, χειρόγραφα, εφημερίδες και μουσική από πάνω από 4000 μουσεία, αρχεία, γκαλερί και βιβλιοθήκες {δωρεάν}.",
    "title": "Ανακαλύψτε την ευρωπαϊκή πολιτιστική κληρονομιά"
  },
  "imageSlider": {
    "handle": "Ρυθμιστικό"
  },
