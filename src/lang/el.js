export default {
  "account": {
    ...
    "curatedCollectionsInfo": "Βρείτε παρακάτω όλες τις συλλογές που έχετε επιμεληθεί",
    ...
    "notifications": {
      ...
      "noCollections": {
        "curated": "Δεν έχετε επιμεληθεί ακόμη καμία συλλογή",
  ...
  "entity": {
    "actions": {
      "cancel": "Ματαίωση",
      "pin": "Καρφίτσωμα στοιχείου",
      "unpin": "Ξεκαρφίτσωμα στοιχείου",
    ...
    "prompts": {
      "pin": "Είστε βέβαιοι ότι θέλετε να καρφιτσώσετε αυτό το στοιχείο; Αυτό το στοιχείο θα εμφανιστεί στο επάνω μέρος της {entity} \". Αυτή η αλλαγή ενδέχεται να διαρκέσει έως και 24 ώρες για να εφαρμοστεί.",
      "unpin": "Είστε βέβαιοι ότι θέλετε να ξεκαρφτίζουν αυτό το στοιχείο; Αυτό το στοιχείο θα σταματήσει να εμφανίζεται στο επάνω μέρος της συλλογής \"{entity}\". Αυτή η αλλαγή μπορεί να διαρκέσει έως και 24 ώρες για να τεθεί σε ισχύ."
    }
  },
  "error": "Σφάλμα",
  "exhibitions": {
  ...
  "items": {
    ...
    "recommended": "Συνιστώμενα στοιχεία",
    "youMightLike": "Αντικείμενα που μπορεί να σας αρέσουν"
  },
  "klaro": {
    "main": {
      "acceptAll": "Αποδεχτείτε τα πάντα",
  ...
  "modal": {
    "download": {
      "clickToCopy": "Κάντε κλικ στην απόδοση για να την αντιγράψετε",
  ...
  "multilingual": {
    ...
    "currentLanguage": "Θα θέλατε να δείτε αυτό το στοιχείο στο {0};",
    "differentLanguage": "μια διαφορετική γλώσσα",
    "enrichment": "Εμπλουτισμός με έργα συνεργατών",
    "original": "Αρχικά μεταδεδομένα",
