export default {
  ...
  "facets": {
    ...
    "api": {
      ...
      "switchMoreInfo": "Σε αυτή τη συλλογή, μπορείτε να κάνετε αναζήτηση μέσα στις πληροφορίες που περιγράφουν το αντικείμενο, όπως κάνετε σε άλλες συλλογές, απενεργοποιώντας αυτό το διακόπτη. Ή να αφήσετε αυτό το διακόπτη ενεργοποιημένο για να κάνετε αναζήτηση μέσα στο κείμενο της εφημερίδας και του εγγράφου."
    },
    "button": {
      "apply": "Εφαρμογή",
      "cancel": "Ακύρωση",
