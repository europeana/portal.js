export default {
  ...
  "facets": {
    ...
    "RIGHTS": {
      ...
      "options": {
        ...
        "*/InC-EDU/*": "Σε πνευματικά δικαιώματα - Επιτρέπεται η εκπαιδευτική χρήση",
        "*/InC-OW-EU/*": "Σε Πνευματικά Δικαιώματα - OW-EU",
        "*/InC/*": "Σε Πνευματικά δικαιώματα",
        ...
        "*/rights/rr-f/*": "Δικαιώματα διατηρούνται - Ελεύθερη πρόσβαση",
        "*/rights/unknown/*": "Άγνωστη κατάσταση πνευματικών δικαιωμάτων"
      }
    },
    "TYPE": {
      "name": "Τύπος μέσων",
  ...
  "sideFilters": {
    ...
    "search": "Αναζήτηση",
    "select": "Επιλέξτε ένα {φίλτρο} | Επιλέξτε {φίλτρο}"
  },
  "statuses": {
    "liked": "Άρεσε",
    "pinned": "Καρφιτσωμένο"
