export default {
  ...
  "facets": {
    ...
    "api": {
      ...
      "switchMoreInfo": "В тази колекция можете да търсите в информацията, описваща артикула, както правите в други колекции, като деактивирате този превключвател. Или оставете този превключвател активиран, за да търсите във вестника и текста на документа."
    },
    "button": {
      "apply": "Прилагане",
      "cancel": "Отказ",
