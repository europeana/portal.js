export default {
  ...
  "entity": {
    ...
    "notifications": {
      ...
      "pinnedFirstPage": "Елементът е закачен. Може да отнеме до 24 часа, докато се появи за всички.",
      ...
      "unpinnedFirstPage": "Елементът е премахнат. Може да отнеме до 24 часа, докато изчезне за всички."
    },
    "prompts": {
