export default {
  ...
  "items": {
    ...
    "recommendationsDisclaimer": "Палец нагоре, за да добавите към галерията - палец надолу, ако не ви харесва",
  ...
  "klaro": {
    ...
    "services": {
      ...
      "google-optimize": {
        "description": "Позволява ви да участвате в експерименти с уебсайтове, които насочват избора ни за дизайн за най-доброто потребителско изживяване.",
        "title": "Google Оптимизиране"
      },
      "hotjar": {
