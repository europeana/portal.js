...
<script>
  ...
  export default {
    ...
    computed: {
      keycloakAccountUrl() {
        return `${this.$auth.strategy.options.origin}/auth/realms/${this.$auth.strategy.options.realm}/account?referrer=${this.$auth.strategy.options.client_id}&kc_locale=${this.$i18n.locale}`;
      },
